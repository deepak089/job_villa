...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <table id="example" class="display" style="width:100%">
    ...
    <tbody>
      ...
      $sql = mysqli_query($conn, "SELECT * FROM all_job WHERE customer_email = '{$_SESSION['admin_email']}'");
      ...
      ?>
          <tr>
            ...
            <td>
              <div class="row">
                <a href="edit_job.php?edit=<?php echo $row['job_id'];?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
